        ...
        <div className="grid md:grid-cols-5 gap-8 lg:gap-12 items-center">
          ...
          <div className="md:col-span-2">
            <div 
              ...
              style={{ backgroundImage: `url(https://images.unsplash.com/photo-1472396961693-142e6e269027?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80)` }}
            ></div>
            <p className="text-center text-sm text-redwood-500 mt-2 italic">
              The old well, the only remaining structure from the 1800s.
            </p>
          </div>
        </div>
      </div>
